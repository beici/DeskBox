...
public sealed class AotStage4E5ContractTests
{
    ...
    public void NativeAotBuild_DeclaresTheStage4E5WarningReduction()
    {
        ...
        Assert.Contains("$stage4E4MaximumWmc1510Count = 1232", audit, StringComparison.Ordinal);
        Assert.Contains("$stage4E5ExpectedWmc1510Count = 1232", audit, StringComparison.Ordinal);
