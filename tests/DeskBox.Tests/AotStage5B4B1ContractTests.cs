...
public sealed class AotStage5B4B1ContractTests
{
    ...
    public void DeepSettingsProjection_UsesAotSafeObjectVectorsAndGeneratedBindableItems()
    {
        ...
        Assert.Contains(
            ...
            xaml,
            StringComparison.Ordinal);
        Assert.Equal(351, CountOccurrences(bindableViewModel, "nameof("));
    ...
    public void AuditFreezesDeepSettingsSourcesRoutesProjectionAndWarnings()
    {
        ...
        Assert.Contains("stage5B4B1ExpectedBindableViewModelPropertyCount = 351", audit, StringComparison.Ordinal);
        ...
        Assert.Contains("stage5B4B1ExpectedWmc1510Count = 742", audit, StringComparison.Ordinal);
    }
